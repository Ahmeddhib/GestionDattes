...
export const PERMISSIONS = {
    ...
    // Regions
    "region:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.LABORANTIN, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    "region:create": [ROLES.ADMIN],
    "region:update": [ROLES.ADMIN],
    "region:delete": [ROLES.ADMIN],

    // Agriculteurs
    "agriculteur:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    "agriculteur:create": [ROLES.ADMIN, ROLES.AGENT],
    "agriculteur:update": [ROLES.ADMIN, ROLES.AGENT],
    "agriculteur:delete": [ROLES.ADMIN],

    // Types de Caisses
    "type-caisse:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    ...
    // Types de Dattes
    "types_dates:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.LABORANTIN, ROLES.DIRECTION],
    ...
    // Livraisons
    "livraison:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.LABORANTIN, ROLES.DIRECTION],
    ...
    // Livreurs
    "livreur:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    "livreur:create": [ROLES.ADMIN, ROLES.AGENT],
    "livreur:update": [ROLES.ADMIN, ROLES.AGENT],
    "livreur:delete": [ROLES.ADMIN],

    // Prêts de Caisses
    "pret-caisse:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    ...
    // Pesée
    "pesee:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    "pesee:create": [ROLES.ADMIN, ROLES.AGENT],
    "pesee:update": [ROLES.ADMIN, ROLES.AGENT],
    "pesee:delete": [ROLES.ADMIN],

    // Bons d'achat
    "bon-achat:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    ...
    "stock-date:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.LABORANTIN, ROLES.DIRECTION],

    // Audit
    "audit:read": [ROLES.ADMIN, ROLES.DIRECTION],

    // Saisons
    "saison:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    ...
    // Ventes
    "vente:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    ...
    "paiement-agriculteur:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
    "paiement-agriculteur:create": [ROLES.ADMIN, ROLES.AGENT, ROLES.RESPONSABLE_STOCK],

    // Encaissements clients (règlement des ventes)
    "encaissement-client:read": [ROLES.ADMIN, ROLES.USER, ROLES.AGENT, ROLES.RESPONSABLE_STOCK, ROLES.DIRECTION],
