        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent
                ...
                className={premiumDashboard
                    ...
                    : "w-[min(18rem,calc(100vw-1rem))] rounded-lg border border-gray-200 bg-white shadow-lg"}
            >
                    ...
                    {displayedTenants.map((tenant) => (
                        <DropdownMenuItem
                            ...
                            className={premiumDashboard
                                ...
                                : "mx-2 cursor-pointer rounded-md px-3 py-3 transition-colors hover:bg-[#FAF0DC] focus:bg-[#FAF0DC]"}
                        >
