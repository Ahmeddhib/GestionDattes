...
export function DashboardContent({
    ...
    return (
        <div className="dashboard-premium relative min-h-full w-full min-w-0 overflow-hidden text-[#f8f1e4]">
            ...
            <div aria-hidden className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_75%_-8%,rgba(193,122,43,0.10),transparent_34%),linear-gradient(180deg,rgba(255,252,247,0.78),#fbf7f1_42%)] dark:bg-[radial-gradient(circle_at_48%_-10%,rgba(132,77,24,0.20),transparent_35%),linear-gradient(180deg,rgba(8,7,5,0.68),#0b0907_42%)]" />
